...
| **audit-it.ru** | `/buh_otchet/{ИНН}_{slug}` | глубокий финанализ: коэффициенты (автономия, ликвидность, ROE/ROA, EBIT), аудиторское заключение | в живом тесте 15.06.2026 отставал на год (давал 2023, когда другие 2024); позже у него встречается и отчётность 2025 — свежесть проверяй по карточке, а не по репутации |
