...
**Источники — по каскаду дешевизны:** бесплатные скрипты ФНС (ЕГРЮЛ, Прозрачный бизнес, ГИР БО — без ключей, `scripts/fetch_counterparty.py`) → токен-API ФССП → агрегаторы через браузер (checko, list-org, СБИС, audit-it, rusprofile — все без капчи и регистрации) → ручной ввод как последняя опция.
